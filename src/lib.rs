...
#[cfg(test)]
    ...
    fn test_sendrecv_multiple() {
        ...
        device.add_write(&vec![0x01, 0x02, 0x03, 0x04, 0x02], 1);
        device.add_write(&vec![0x01, 0x02, 0x03, 0x04, 0x03, 0x01, 0x01, 0x01,
        ...
        device.add_read(&vec![0x01, 0x02, 0x03, 0x04, 0x02], 1);
        device.add_read(&vec![0x01, 0x02, 0x03, 0x04, 0x03, 0x01, 0x01, 0x01,
                              0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
                              0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
                              0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
                              0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
