...
mod test {
    ...
    fn serialize_user() {
        let user = User {
            id: vec![0x30, 0x82, 0x01, 0x93, 0x30, 0x82, 0x01, 0x38, 0xa0, 0x03,
        ...
        assert_eq!(payload, vec![
            0xa4,                                                               // map(4)
                ...
                0x78, 0x2b,                                                     // text(43)
                    0x68, 0x74, 0x74, 0x70, 0x73, 0x3a, 0x2f, 0x2f, 0x70, 0x69, // "https://pics.example.com/00/p/aBjjjpqPb.png"
                ...
                0x64,                                                           // text(4)
                    0x6e, 0x61, 0x6d, 0x65,                                     // "name"
                0x76,                                                           // text(22)
                    0x6a, 0x6f, 0x68, 0x6e, 0x70, 0x73, 0x6d, 0x69, 0x74, 0x68, // "johnpsmith@example.com"
    ...
    fn public_key_desc() {
        let key = PublicKeyCredentialDescriptor {
            id: vec![0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06,
