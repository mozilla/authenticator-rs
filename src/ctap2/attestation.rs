...
pub mod test {
    ...
    fn serialize_att_obj_fido_u2f() -> Result<(), serde_cbor::Error> {
        ...
        assert_eq!(
            serde_cbor::ser::to_vec(&att_stmt)?,
            // Generated by a Python script similar to other test values, but
            // with fido2.cbor.encode patched to NOT encode map entries in
            // canonical CBOR order so that "x5c" may precede "sig"
            [
                0xa2, 0x63, 0x78, 0x35, 0x63, 0x82, 0x44, 0x05, 0x06, 0x07, 0x08, 0x44, 0x09, 0x0a,
                0x0b, 0x0c, 0x63, 0x73, 0x69, 0x67, 0x44, 0x01, 0x02, 0x03, 0x04
            ],
        );
        ...
        assert_eq!(
            ...
            [
                ...
                0x67, 0x61, 0x74, 0x74, 0x53, 0x74, 0x6d, 0x74, 0xa2, 0x63, 0x78, 0x35, 0x63, 0x82,
                0x44, 0x05, 0x06, 0x07, 0x08, 0x44, 0x09, 0x0a, 0x0b, 0x0c, 0x63, 0x73, 0x69, 0x67,
                0x44, 0x01, 0x02, 0x03, 0x04, 0x68, 0x61, 0x75, 0x74, 0x68, 0x44, 0x61, 0x74, 0x61,
                0x58, 0xa2, 0xc2, 0x89, 0xc5, 0xca, 0x9b, 0x04, 0x60, 0xf9, 0x34, 0x6a, 0xb4, 0xe4,
                0x2d, 0x84, 0x27, 0x43, 0x40, 0x4d, 0x31, 0xf4, 0x84, 0x68, 0x25, 0xa6, 0xd0, 0x65,
                0xbe, 0x59, 0x7a, 0x87, 0x05, 0x1d, 0xc1, 0x00, 0x00, 0x00, 0x0b, 0xf8, 0xa0, 0x11,
                0xf3, 0x8c, 0x0a, 0x4d, 0x15, 0x80, 0x06, 0x17, 0x11, 0x1f, 0x9e, 0xdc, 0x7d, 0x00,
